class StringProcessingAdvance {
    ...
    public static void main(String[] args) {
        ...
        // String repetition
        String repeatedString = repeatString(originalString, 3);
        System.out.println("Repeated String: " + repeatedString);

        // Checking if a string is blank
        String blankString = "   ";
        System.out.println("Is Blank String: " + isStringBlank(blankString));

        // Extracting lines from a multi-line string
        System.out.println("Lines from Multi-line String:");
        extractLines(multiLineString);

        // String formatting
        String formattedString = formatString("Hello %s", "World");
        System.out.println("Formatted String: " + formattedString);

        // String indentation
        String indentedString = indentString(multiLineString, 2);
